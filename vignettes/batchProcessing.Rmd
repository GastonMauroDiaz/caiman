...
The main function of *caiman* package is run *doOBIA* to get binarized images whit the aim of extract gap fraction and estimate forest structure or understory light transmission. The later will needs further process with a specific software as [CIMES]( http://jmnw.free.fr/).
